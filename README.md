...
7. พอได้ค่า Spearman’s correlation นำไป plot heatmap เนื่องจากข้อมูลมีหลายประเทศ จึงตัดข้อมูลที่ออกมาจาก Spearman’s correlation ไป 1 หลัก และตัดค่าที่เท่ากับ 1 ออก เนื่องจากค่าที่เป็น 1 คือค่าที่ตัวแปรเหมือนกัน มีความสัมพันธ์กันเอง และเลือกใช้สีแบบ coolwarm เนื่องจากเป็นโทนสีที่ตัดกัน จึงทำให้สามารถมองข้อมูลได้ง่ายขึ้น และสร้างกราฟ scatter plot
...
8. หาค่าเฉลี่ยของความสัมพันธ์ เพื่อมาเปรียบเทียบ

<img width="996" alt="image" src="https://user-images.githubusercontent.com/115640119/196047139-ee88c435-d5bd-405a-b47b-5d523f0044e0.png">
...
# Conclusion
ตลาดหุ้นแทบจะไม่มีมีความสัมพันธ์กับรายได้ต่อหัว ถ้าเทียบตามรายทวีป ประเทศที่สอดคล้องกันมากที่สุดคือประเทศกาน่า รวมถึงประเทศจีนมีความสัมพันธ์ทางรายได้ต่อหัวกับทวีปและประเทศอื่นๆ มากกว่าสหรัฐ หากต้องการต้องการดูรายได้ต่อหัว ควรอิงจากประเทศจีน ว่าถ้าจีนโต มีโอกาสสูงที่ประเทศอื่นๆ จะโตตาม ส่วนตลาดหุ้นควรดูจากสหรัฐ เนื่องจากสหรัฐมีความสัมพันธ์กับทวีป และประเทศอื่นๆ มากกว่าจีน 
